                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="form-group">
                          ...
                          <input type="number" min="1" step="any" value="<?php echo $stock_db; ?>" class="form-control" placeholder="Enter Stock" name="txtstock" required>
                        </div>
                        
                      <div class="form-group">
                          <label>Purchase Price</label>
                          <input type="number" min="1" step="any" value="<?php echo $purchaseprice_db; ?>" class="form-control" placeholder="Enter Stock" name="txtpurchaseprice" required>
                        </div>

                      <div class="form-group">
                          <label>Sale Price</label>
                          <input type="number" min="1" step="any" value="<?php echo $saleprice_db; ?>" class="form-control" placeholder="Enter Stock" name="saleprice" required>
                        </div>
